...
{   
    ...
    public void testMissingSubcolumn() {
    	SuperColumn sc = new SuperColumn("sc1".getBytes(), new LongType(), ClockType.Timestamp, null);
    ...
    {
    	SuperColumn sc = new SuperColumn("sc1".getBytes(), new LongType(), ClockType.IncrementCounter, new IncrementCounterReconciler());
