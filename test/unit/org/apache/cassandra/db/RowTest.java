...
public class RowTest extends SchemaLoader
{
    ...
    {
        SuperColumn sc1 = new SuperColumn("one".getBytes(), new AsciiType(), ClockType.Timestamp, null);
        sc1.addColumn(column("subcolumn", "A", new TimestampClock(0)));

        SuperColumn sc2 = new SuperColumn("one".getBytes(), new AsciiType(), ClockType.Timestamp, null);
