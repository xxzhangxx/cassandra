...
public class RowTest
{
    ...
    {
        SuperColumn sc1 = new SuperColumn("one".getBytes(), new AsciiType(), ColumnType.Super, null);
        sc1.addColumn(column("subcolumn", "A", new TimestampClock(0)));

        SuperColumn sc2 = new SuperColumn("one".getBytes(), new AsciiType(), ColumnType.Super, null);
