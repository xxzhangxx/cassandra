...
{   
    ...
    {
        CFMetaData newCf = new CFMetaData("MadeUpKeyspace", "NewCF", ColumnFamilyType.Standard, ClockType.Timestamp, new UTF8Type(), null, null, "new cf", 0, false, 0);
        try
        {
    ...
    public void testMigrations() throws IOException, ConfigurationException
    {
        ...
        // add a cf.
        CFMetaData newCf1 = new CFMetaData("Keyspace1", "MigrationCf_1", ColumnFamilyType.Standard, ClockType.Timestamp, new UTF8Type(), null, new TimestampReconciler(), "Migration CF ", 0, false, 0);
    ...
    public void addNewCF() throws ConfigurationException, IOException, ExecutionException, InterruptedException
    {
        ...
        CFMetaData newCf = new CFMetaData(original.name, cf, ColumnFamilyType.Standard, ClockType.Timestamp, new UTF8Type(), null, new TimestampReconciler(), "A New Column Family", 0, false, 0);
    ...
    {
        DecoratedKey dk = Util.dk("key0");
        CFMetaData newCf = new CFMetaData("NewKeyspace1", "AddedStandard1", ColumnFamilyType.Standard, ClockType.Timestamp, new UTF8Type(), null, new TimestampReconciler(), "A new cf for a new ks", 0, false, 0);
