...
public class VersionVectorContextTest
{
    ...
    public void testCompare()
    {
        ...
        assert IClock.ClockRelationship.EQUAL ==
        ...
        assert IClock.ClockRelationship.GREATER_THAN ==
            vvc.compare(left, right);
        ...
        assert IClock.ClockRelationship.LESS_THAN ==
            vvc.compare(left, right);
        ...
        assert IClock.ClockRelationship.DISJOINT ==
            vvc.compare(left, right);
