...
import org.apache.cassandra.db.AbstractCounterClock;
...
public abstract class AbstractCounterReconciler extends AbstractReconciler
{
    ...
    protected static IClock mergeClocks(Column left, Column right)
    {
    ...
    public Column reconcile(Column left, Column right)
    {
        ...
        else
        {
            ...
            byte[] value = getContextManager().total(((AbstractCounterClock)clock).context());
